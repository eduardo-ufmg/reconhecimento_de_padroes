...
from bayes.old.train import GaussianParams
...
def pred_multivariate_normal(X: np.ndarray, params1: GaussianParams, params2: GaussianParams) -> np.ndarray:
  ...
  pdf1 = multivariate_normal(params1.mean, params1.cov, allow_singular=True).pdf(X)
  pdf2 = multivariate_normal(params2.mean, params2.cov, allow_singular=True).pdf(X)
