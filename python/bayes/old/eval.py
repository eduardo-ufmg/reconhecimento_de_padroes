...
from bayes.old.train import train, GaussianParams
from bayes.old.pred import predict, multivariate_normal
...
def visualize_results(
  ...
  from bayes.old.pred import _vectorized_gaussian_mixture
