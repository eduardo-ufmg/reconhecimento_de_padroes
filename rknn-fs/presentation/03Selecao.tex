...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{../code/examples/instdt_decisionbound.png}
    \caption{Região de decisão de uma árvore de decisão instável}
...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{../code/examples/instdt_structure.png}
    \caption{Estrutura de uma árvore de decisão instável}
    \label{fig:decision_structure}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{../code/examples/rf.png}
    \caption{Exemplo mínimo de uma floresta aleatória}
    \label{fig:rf}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.625\textwidth]{../code/examples/xor.png}
    \caption{Análise estatística de variáveis em um problema XOR}
    \label{fig:xor}
\end{figure}
\end{frame}
...
\begin{frame}
\centering
\lstinputlisting{../code/examples/redundant_out.txt}
\end{frame}
