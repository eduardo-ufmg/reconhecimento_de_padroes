...
\textbf{RKNN-FS}
\begin{itemize}
    \item \textit{feature support}: $ O(rk2^mn\log{n}) $
    \item \textit{feature selection}: $ O(rk2^mn\log{n}) $
    \item algoritmo completo: $ O(rk2^mn\log{n}) $
\end{itemize}
...
\textbf{RF-FS}
\begin{itemize}
    \item treinamento: $ O(rmn\log{n}) $
    \item predição: $ O(r\log{n}) $
\end{itemize}
