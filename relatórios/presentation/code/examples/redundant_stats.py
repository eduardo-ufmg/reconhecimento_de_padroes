...
X, y = make_classification(n_samples=1000, n_features=3, n_informative=1, n_redundant=2, n_clusters_per_class=1)
...
""".format(np.corrcoef(X[:,0], X[:,1])[0,1], np.corrcoef(X[:,0], X[:,2])[0,1]))
